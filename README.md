...
📂 Dataset
For this project it is required to have dataset consists of 5 common fruits found in Malaysia. Images were manually gathered from Kaggle and Google Images and annotated using Roboflow.
...
- Annotation Tool: Roboflow
  ...
  Here is a comprehensive README.md file tailored for your GitHub repository, based on the project report and code documentation provided.
